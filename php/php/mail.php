...
$project_name = trim($_POST["project_name"]); //откуда придет письмо, с какого сайта
$admin_email  = trim($_POST["admin_email"]); //на какой адрес оно должно прийти
...
// header('location: ../thankyou.php'); //Если бы я хотела отправлять не методом ajax, а чтобы переходило на новую страницу. Т.е. у себя в папке, мне нужно было бы создать страницу thankyou в ней там какую-нибудь картинку и текст.
